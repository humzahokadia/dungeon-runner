    ...
    public void SpawnEnemy()
    {
        ...
        for (int a = 0; a < enemies.Length; a++)
        {
            if (a == b)
            {
                ...
                if (a == 4)
                    ...
                    currentRotation.eulerAngles = new Vector3(180, 90, 0);
                newo = Instantiate(enemies[a].transform, new Vector3(nextPosX + 5F, nextPosY + 5F, 0), currentRotation);
                newo.gameObject.AddComponent<Destroy>();
            }
        }
        ...
        for (int a = 0; a < powerUp.Length; a++)
        {
            if (a == b)
            {
                ...
                newo = Instantiate(powerUp[a].transform, new Vector3(nextPosX + 5F, nextPosY + 3F, -2.4f), currentRotation);
                newo.gameObject.AddComponent<Destroy>();
            }
        }
